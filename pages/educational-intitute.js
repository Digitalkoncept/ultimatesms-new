...
const educationalintitute = () => {
  return (
    <div>
        <>
  <section
    className="dark:bg-coolGray-800 dark:text-coolGray-100"
    style={{ backgroundColor: "#edefff" }}
  >
    <div className="container mx-auto flex flex-col items-center px-4 py-16 text-center md:py-32 md:px-10 lg:px-32 xl:max-w-3xl">
      ...
      <div className="flex flex-wrap justify-center">
        ...
        <button className="px-8 py-3 m-2 text-lg border border-black rounded dark:text-coolGray-50 dark:border-coolGray-700 hover:text-white hover:bg-black duration-500">
          Learn more
        </button>
      </div>
    </div>
...
export default educationalintitute
